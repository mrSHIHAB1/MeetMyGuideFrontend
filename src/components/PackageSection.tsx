...
export default function PackageSection() {
  ...
  return (<> <p className="text-6xl text-center font-semibold">Packages</p>
    <div className="my-10 flex justify-center items-center p-8  relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full">
        ...
        {[
          ...
          <div
            key={i}
            className={`${plan.bg} rounded-2xl p-8 shadow-xl relative flex flex-col items-center ${plan.bg === "bg-indigo-600" ? "scale-105" : ""
              }`}
          >
            {plan.tag && (
            ...
            <ul
              className={`text-sm space-y-2 mb-8 text-center ${plan.bg === "bg-indigo-600" ? "text-white/90" : "text-gray-600"
                }`}
            >
            ...
            <button
              className={`rounded-lg px-6 py-3 font-medium transition ${plan.bg === "bg-indigo-600"
