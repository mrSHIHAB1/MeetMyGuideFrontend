        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl overflow-hidden border border-gray-100 flex flex-col md:flex-row">
          ...
          <div className="md:flex-1 p-6 sm:p-8 lg:p-12">
            <div className="mb-8 sm:mb-10 text-center md:text-left">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1 sm:mb-2">Create Tourist Account</h3>
              <p className="text-sm sm:text-base text-gray-500">Join our community of travelers today.</p>
            </div>
            ...
            <form action={formAction} encType="multipart/form-data" className="space-y-5 sm:space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                ...
                <div className="col-span-2">
                  <label className="text-xs sm:text-sm font-semibold text-gray-700 mb-2 block">Current Address</label>
                  <div className="relative group">
              ...
              <div className="space-y-4 sm:space-y-5 pt-4 sm:pt-6 border-t border-gray-100">
                <h4 className="text-sm sm:text-base font-semibold text-gray-900 border-l-4 border-blue-500 pl-3">Preferences & Bio</h4>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
                  <div className="col-span-2">
                    <label className="text-xs sm:text-sm font-semibold text-gray-700 mb-2 block">Tell Us About Yourself</label>
                    <div className="relative group">
                      ...
                      <textarea
                        ...
                        className="w-full pl-10 pr-4 py-2.5 sm:py-3 text-sm sm:text-base bg-gray-50 border border-gray-200 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 min-h-[80px] sm:min-h-[100px] transition-all resize-none"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-1">
                    <label className="text-xs sm:text-sm font-semibold text-gray-700 mb-2 block">Travel Preferences</label>
                    <div className="relative group">
                      <Compass className="absolute left-3 top-1/2 -translate-y-1/2 w-4 sm:w-5 h-4 sm:h-5 text-gray-400 group-focus-within:text-blue-500 transition-colors" />
                      <input
                        type="text"
              ...
              <div className="pt-5 sm:pt-6">
                ...
                >
                  Create Account <ChevronRight className="w-4 sm:w-5 h-4 sm:h-5" />
                </button>
              </div>
            </form>
