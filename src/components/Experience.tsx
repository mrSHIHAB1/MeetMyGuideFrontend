...
export default function ExperienceSharing() {
    return (
        <div className="w-full  bg-gradient-to-br from-gray-300 to-gray-100  p-12 flex flex-col gap-12">
            ...
            {/* Cards */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 container mx-auto  px-7">
