        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 flex flex-col md:flex-row">
          ...
          <div className="md:w-1/3 bg-blue-600 p-8 text-white flex flex-col justify-between relative overflow-hidden">
            <div className="relative z-10">
              <h2 className="text-3xl font-bold mb-4">Join Our Guide Network</h2>
          ...
          <div className="md:flex-1 p-8 lg:p-12">
            <div className="mb-10 text-center md:text-left">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Request Guide Account</h3>
              <p className="text-gray-500">Fill in your details to start your journey with us.</p>
            </div>
            ...
            <form action={formAction} encType="multipart/form-data" className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="col-span-2">
                  <label className="text-sm font-semibold text-gray-700 mb-2 block">Physical Address</label>
                  <div className="relative group">
              ...
              <div className="space-y-5 pt-4 border-t border-gray-100">
                <h4 className="font-semibold text-gray-900 border-l-4 border-blue-500 pl-3">Professional Details</h4>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="col-span-2">
                    <label className="text-sm font-semibold text-gray-700 mb-2 block">Brief Bio</label>
                    <div className="relative group">
                      ...
                      <textarea
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 min-h-[100px] transition-all"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-1">
                    <label className="text-sm font-semibold text-gray-700 mb-2 block">Daily Rate (BDT)</label>
                    <div className="relative group">
                      <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-blue-500 transition-colors" />
                      <input
                        type="number"
                        name="dailyrate"
                        placeholder="1500"
                  ...
                  <div className="col-span-2">
                    <label className="text-sm font-semibold text-gray-700 mb-2 block">Areas of Expertise</label>
                    <div className="relative group">
